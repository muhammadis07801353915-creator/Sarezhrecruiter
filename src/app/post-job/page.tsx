...
export default function JobForm() {
  ...
  const { addJobRequest, jobQuestions, fetchData } = useDataStore();
  ...
  if (isSubmitted) {
    return (
      ...
      >
        ...
        <Button size="lg" className="rounded-full bg-gray-900 hover:bg-gray-800 text-white" onClick={() => router.push('/')}>
          {t('go_home')}
        </Button>
      </motion.div>
    );
